    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {isCookingMode && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          {/* Backdrop */}
          <div className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm" onClick={exitCookingMode}></div>
          
          {/* Modal Content */}
          <div className="relative w-full h-full flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl h-full max-h-[95vh] overflow-hidden animate-scale-in">
              {/* Cooking Mode Header */}
              <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl sm:text-2xl font-bold">Cooking Mode</h2>
                      <p className="text-orange-100 text-sm sm:text-base">Step {currentStep + 1} of {displayRecipe.steps?.length || 0}</p>
                    </div>
                  </div>
              ...
              <div className="h-full overflow-y-auto">
                ...
                <div className="relative">
                  {/* Chef Avatar & Message */}
                  <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4 sm:p-6 bg-gradient-to-r from-orange-50 to-red-50">
                    <div className="relative flex-shrink-0 mx-auto sm:mx-0">
                      {/* 2D Chef Character */}
                      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-b from-orange-300 to-orange-400 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="flex-1 w-full sm:w-auto">
                      <div className="bg-white rounded-lg p-4 shadow-lg relative">
                        ...
                        <div className="hidden sm:block absolute left-0 top-4 transform -translate-x-2">
                          <div className="w-4 h-4 bg-white rotate-45"></div>
                        </div>
                ...
                <div className="p-4 sm:p-6">
                  <div className="mb-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4">
                      ...
                      <span className="text-lg sm:text-xl font-semibold text-gray-800">Current Step</span>
                      
                      {/* Timer Display */}
                      {isTimerRunning && (
                        <div className="flex items-center space-x-2 bg-blue-100 text-blue-800 px-3 py-2 rounded-lg">
                          <Timer className="h-4 w-4" />
                          <span className="font-mono font-bold text-sm sm:text-base">{formatTime(cookingTimer)}</span>
                        </div>
                      )}
                    </div>
                    
                    <div className="bg-gray-50 rounded-xl p-4 sm:p-6 border-l-4 border-orange-500">
                      ...
                      {/* Quick Timer Buttons */}
                      <div className="flex flex-wrap gap-2">
                        <span className="text-sm text-gray-600 mr-2 w-full sm:w-auto">Quick timers:</span>
                        {[5, 10, 15, 20].map((minutes) => (
                          <button
                            key={minutes}
                            onClick={() => startTimer(minutes)}
                  ...
                  <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 mb-6">
                    <button
                      onClick={prevStep}
                      disabled={currentStep === 0}
                      className="flex items-center justify-center space-x-2 px-4 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <SkipBack className="h-4 w-4" />
                      <span>Previous</span>
                    </button>
